...
public class SepiaImageConverter extends IColorConverterDecorator {
    public SepiaImageConverter(IColorConverter converter) {
        super(converter);
    }
    ...
    @Override
    public String getExtension() { return "s_" + super.getExtension(); }
}